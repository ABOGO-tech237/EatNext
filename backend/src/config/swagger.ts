...
const definition: swaggerJSDoc.Options['definition'] = {
  ...
  components: {
    ...
    schemas: {
      ...
      RestaurantSource: {
        type: 'string',
        enum: ['USER_SUBMITTED', 'OSM_SYNC'],
        description: 'Origine du restaurant (utilisateur ou synchronisation OpenStreetMap).',
      },
      ComplaintType: {
        type: 'string',
      ...
      Restaurant: {
        ...
        properties: {
          ...
          source: { $ref: '#/components/schemas/RestaurantSource' },
          osmId: { type: 'string', nullable: true, description: 'Identifiant OpenStreetMap (unique)' },
          osmType: { type: 'string', nullable: true, enum: ['node', 'way', 'relation'] },
          osmTags: { type: 'object', additionalProperties: { type: 'string' }, nullable: true },
          lastSyncedAt: { type: 'string', format: 'date-time', nullable: true },
          openingHours: { type: 'string', nullable: true },
          phone: { type: 'string', nullable: true },
          website: { type: 'string', nullable: true, format: 'uri' },
          distance: { type: 'number', description: 'Distance en mètres (recherche géographique)' },
          createdAt: { type: 'string', format: 'date-time' },
          updatedAt: { type: 'string', format: 'date-time' },
        },
      },
