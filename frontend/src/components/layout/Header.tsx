...
/**
 * En-tête sticky — ligne develop (blanc flouté, logo E rouge) + liens restaurateur.
 */
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-ink-100 bg-white/95 shadow-sm backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        <Link to="/" className="group flex items-center gap-2" aria-label="EatNext — accueil">
        ...
        <nav className="hidden items-center gap-1 md:flex" aria-label="Navigation principale">
          ...
          <NavLink to="/pro" className={navLinkClass}>
            ...
            {isOwner ? 'Mon établissement' : 'Pour les restaurateurs'}
          </NavLink>
        </nav>
      ...
      {mobileOpen && (
        <div className="nav-drawer border-t border-ink-100 bg-white px-4 py-3 md:hidden">
