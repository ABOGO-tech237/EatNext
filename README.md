...
- **`main`** — infrastructure, documentation et socle partagé
- **Branches dédiées** — fonctionnalités et évolutions (`feature/…`, `setup/…`, etc.)

Travaillez sur une branche de feature, puis fusionnez vers `main` après revue.
