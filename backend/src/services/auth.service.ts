 ...
 *
 * Gère l'inscription, la connexion par mot de passe (haché via bcrypt), le
 * renouvellement de jetons et un stub de connexion Google. Les réponses ne
 * renvoient jamais le hash du mot de passe (cf. `sanitizeUser`).
 */
...
export async function registerUser(input: {
  ...
  // L'email est normalisé en minuscules pour garantir l'unicité (clé @unique).
 ...
 * Vérifie aussi que le compte n'a pas été banni entre-temps.
 */
